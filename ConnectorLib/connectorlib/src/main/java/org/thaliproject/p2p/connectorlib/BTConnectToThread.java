...
class BTConnectToThread extends Thread{
    ...
    public BTConnectToThread(ConnectionCallback Callback, BluetoothDevice device, UUID BtUUID, String peerId,String peerName, String peerAddress, String InstanceString)  throws IOException {
        callback = Callback;
        mPeerId = peerId;
        mPeerName = peerName;
